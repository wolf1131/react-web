          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Adi.G`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer", "Front-End Developer", "Back-End Developer" ]'><span className="wrap">{text}</span></span></h1>
                  <p>My name is Adi Gridman. I'm a Practical Engineer in Mechatronik and a Full stack developer specializing in the "MERN" stack.
                     ...
                     and now I'm doing it professionally as my main career path!.</p>
